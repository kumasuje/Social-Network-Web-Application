 	 ...
 	 <div class="container" style="padding-left:25px;">  	
		...
		<div class="container" style="position: relative; padding-top: 100px;">
			...
			<div id="recommendblock">
				...
				<c:if test="${fn:length(Suggestion) eq 0}">
                    <p>There are currently no friend suggestions!</p>
                </c:if>
				
				
				 <c:forEach items="${Suggestion}" var="u">
                    <form name="add_form1" id="$(u)" action="" method="GET">
                        <div class="form-group-sm col-sm-12"
                            style="display: inline block;" id="${u.name}">
                           
                        <div class="form-group col-lg-6" >
							<label for="dob">Name</label>
							<input type="text" name="dob" class="form-control" value="${u.name}" disabled>
						</div>
						
	                   <div class="form-group col-lg-6" >
							<label for="dob">Total Mutual Friend </label>
							<input type="text" name="dob" class="form-control" value="${u.numberOfMutualfriend}" disabled>
						</div>
